...
string CAquatory::MovePrint(CCell enemy_Cells[10][10])
{
	
	string str("       Ваше поле      ");
	str += "          ";
	str +=     "    Поле противника   \n";
	...
	for (int i = 0; i < 10; i++)
	{
		...
		for (int j = 0; j < 10; j++)
		{
			str += enemy_Cells[i][j].PrintForeign() + " ";
		}
		str += "\t";
		str += char(97 + i);
		str += "\n";
